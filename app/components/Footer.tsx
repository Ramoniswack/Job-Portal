        ...
        <div className="bg-gray-100 relative">
            ...
            <div className="max-w-6xl py-10 px-4 sm:px-6 text-gray-800 sm:flex justify-between mx-auto pt-20">
                ...
                <div className="p-5 sm:w-7/12 border-r text-center">
                    <h3 className="font-bold text-xl text-[#26cf71] mb-4">Hamro Sewa</h3>
                ...
                <div className="p-5 sm:w-3/12">
                    <div className="text-sm uppercase text-[#26cf71] font-bold">Contact Us</div>
                    <ul>
                        <li className="my-2">
                            <a className="hover:text-[#26cf71]" href="#">Kathmandu, Nepal</a>
                        </li>
                        <li className="my-2">
                            <a className="hover:text-[#26cf71]" href="tel:9842416371">+977 9842416371</a>
                        </li>
                        <li className="my-2">
                            <a className="hover:text-[#26cf71]" href="mailto:info@hamrosewa.com">info@hamrosewa.com</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div className="flex py-5 m-auto text-gray-800 text-sm flex-col items-center border-t max-w-6xl">
                <div className="md:flex-auto md:flex-row-reverse mt-2 flex-row flex">
                    <a href="#" className="w-6 mx-1">
                        <svg className="fill-current cursor-pointer text-gray-500 hover:text-[#26cf71]" width="100%" height="100%" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" xmlSpace="preserve" style={{ fillRule: 'evenodd', clipRule: 'evenodd', strokeLinejoin: 'round', strokeMiterlimit: 2 }}>
