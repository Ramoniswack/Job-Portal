    ...
    if (loading) {
        return (
            <>
                ...
                <div className="pt-24 pb-10 px-4 sm:px-6 bg-gray-50 min-h-screen">
            ...
            <>
                ...
                <div className="pt-24 pb-10 px-4 sm:px-6 bg-gray-50 min-h-screen">
                    <div className="max-w-6xl mx-auto text-center py-20">
                        ...
                        <Link href="/" className="text-[#26cf71] hover:underline">
                            Go back to home
                        </Link>
                    </div>
                </div>
            ...
            <div className="pt-24 pb-10 px-4 sm:px-6 bg-gray-50 min-h-screen">
                <div className="max-w-6xl mx-auto">
                    <div className="text-sm text-gray-500 mb-5">
                        <Link href="/" className="hover:text-[#26cf71]">Home</Link> / {category.name}
                    </div>
                                ...
                                {subcategoryOptions.map((subcategory) => (
                                    <button
                                        ...
                                        className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-200 ${selectedSubcategory === subcategory
                                            ? 'bg-[#26cf71] text-white shadow-md'
                            ...
                            {services.map((service) => (
                                <Link key={service.id} href={`/service/${service.slug}`} className="bg-transparent block">
                                    ...
                                    <div className="space-y-1">
                                        <h3 className="text-lg font-semibold text-gray-900 truncate cursor-pointer hover:text-[#26cf71] transition-colors">
                                            {service.title}
                                        </h3>
