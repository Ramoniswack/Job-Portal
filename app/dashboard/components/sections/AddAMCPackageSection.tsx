...
export default function AddAMCPackageSection({ token, editingPackageId, onBack }: AddAMCPackageSectionProps) {
    ...
    return (
        <div className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 dark:text-gray-500 mt-1">Create or update your AMC package details</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            {/* Form */}
            <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 space-y-6">
                {/* Basic Info */}
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-[#FF6B35] focus:border-transparent"
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Card Image * <span className="text-xs text-gray-500 dark:text-gray-500">(For homepage display)</span>
                        </label>
                        <input
                            type="file"
                            accept="image/*"
                        ...
                        />
                        {uploadingCard && <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">Uploading...</p>}
                        {formData.cardImage && (
                    ...
                    <div>
                        <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                            Hero Image * <span className="text-xs text-gray-500 dark:text-gray-500">(For detail page banner)</span>
                        </label>
                        <input
                            type="file"
                            accept="image/*"
                        ...
                        />
                        {uploadingHero && <p className="text-sm text-gray-500 dark:text-gray-500 mt-2">Uploading...</p>}
                        {formData.heroImage && (
                ...
                <div className="space-y-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Pricing Tiers</h3>
                        <button
                            type="button"
                            onClick={addTier}
                    ...
                    {formData.pricingTiers.map((tier, tierIndex) => (
                        <div key={tierIndex} className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 p-4 rounded-lg space-y-3">
                            <div className="flex items-center justify-between">
                                <h4 className="font-medium text-gray-900 dark:text-gray-100">Tier {tierIndex + 1}</h4>
                ...
                <div className="space-y-4 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <div className="flex items-center justify-between">
                        <h3 className="text-lg font-semibold text-gray-900 dark:text-gray-100">Benefits</h3>
                        <button
                            type="button"
                            onClick={addBenefit}
                            className="flex items-center gap-2 px-4 py-2 bg-[#FF6B35] hover:bg-[#FF5722] text-white rounded-lg transition-colors text-sm"
                    ...
                    {formData.benefits.map((benefit, index) => (
                        <div key={index} className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 p-4 rounded-lg space-y-3">
                            <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-2 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <input
                        ...
                        className="w-4 h-4 text-[#FF6B35] border-gray-300 dark:border-gray-600 rounded"
                    />
                ...
                <div className="flex gap-3 pt-6 border-t border-gray-200 dark:border-gray-700">
                    <button
                        type="button"
                        onClick={onBack}
                        className="flex-1 px-4 py-3 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:bg-gray-900 transition-colors"
                    >
                        Cancel
                    </button>
                    <button
