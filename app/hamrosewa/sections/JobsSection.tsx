    ...
    return (
        <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                ...
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">View all jobs, applications, and messages</p>

                {/* Stats */}
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                    <div className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 rounded-lg p-4">
                        <p className="text-sm text-gray-600 dark:text-gray-400">Total Jobs</p>
                        <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{jobs.filter(j => j.client).length}</p>
                    </div>
            ...
            <div className="overflow-x-auto">
                {loading ? (
                    ...
                    <div className="p-12 text-center">
                        ...
                        <p className="mt-4 text-gray-600 dark:text-gray-400">No jobs found</p>
                    </div>
                ) : (
                        ...
                        <tbody className="divide-y divide-gray-200">
                            {jobs.filter(job => job.client).map((job) => (
                                <tr key={job._id} className="hover:bg-gray-50 dark:bg-gray-900 transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <p className="text-gray-900 dark:text-gray-100 dark:text-gray-100">{job.client.name}</p>
                                        <p className="text-sm text-gray-500 dark:text-gray-500">{job.client.email}</p>
                                    </td>
                                    <td className="px-6 py-4">
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">{job.category}</p>
                                    </td>
                                    <td className="px-6 py-4">
                        ...
                        <div className="p-6 border-b border-gray-200 dark:border-gray-700 sticky top-0 bg-white dark:bg-gray-800">
                            <div className="flex items-start justify-between">
                                <div>
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 mt-1">Posted by {selectedJob.client?.name || 'Unknown'}</p>
                                </div>
                                <button
                                    onClick={() => {
                        ...
                        <div className="p-6 space-y-6">
                            ...
                            <div className="bg-gray-50 dark:bg-gray-900 dark:bg-gray-900 rounded-lg p-4">
                                ...
                                <div className="grid grid-cols-2 gap-4 text-sm">
                                    <div>
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Category</p>
                                        <p className="font-semibold text-gray-900 dark:text-gray-100">{selectedJob.category}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Budget</p>
                                        <p className="font-semibold text-gray-900 dark:text-gray-100">NPR {selectedJob.budget}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Location</p>
                                        <p className="font-semibold text-gray-900 dark:text-gray-100">{selectedJob.location}</p>
                                    </div>
                                    <div>
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Status</p>
                                        <span className={`inline-block px-3 py-1 rounded-full text-xs font-semibold uppercase ${getStatusBadge(selectedJob.status)}`}>
                                            {selectedJob.status}
                                        </span>
                                    </div>
                                    <div className="col-span-2">
                                        <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 mb-1">Description</p>
                                                ...
                                                {applications.map((app) => (
                                                    <div key={app._id} className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                                                            ...
                                                            <div className="flex-1">
                                                                <div className="flex items-center gap-2 mb-1">
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <p className="text-sm text-gray-600 dark:text-gray-400">{app.worker?.email || 'N/A'}</p>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div className="grid grid-cols-2 gap-3 text-sm mb-3 bg-gray-50 dark:bg-gray-900 p-3 rounded-lg">
                                                            <div>
                                                                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold mb-1">Contact Phone</p>
                                                                <p className="text-gray-900 dark:text-gray-100 dark:text-gray-100">{app.phone}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold mb-1">Contact Email</p>
                                                                <p className="text-gray-900 dark:text-gray-100 dark:text-gray-100">{app.email}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold mb-1">Location</p>
                                                                <p className="text-gray-900 dark:text-gray-100 dark:text-gray-100">{app.workerLocation}</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold mb-1">Qualification</p>
                                                                <p className="text-gray-900 dark:text-gray-100 dark:text-gray-100">{app.qualification}</p>
                                                            </div>
                                                        </div>
                                                        <div className="text-sm">
                                                            <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400 font-semibold mb-1">Application Message:</p>
