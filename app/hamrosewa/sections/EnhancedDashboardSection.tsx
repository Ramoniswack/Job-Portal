    ...
    const loadDashboardData = async () => {
        ...
        try {
            ...
            const [servicesRes, categoriesRes, myServicesRes, bookingsRes, amcBookingsRes] = await Promise.all([
                ...
                token ? fetch('http://localhost:5000/api/bookings/all', {
                    headers: { 'Authorization': `Bearer ${token}` }
                }) : Promise.resolve({ ok: false }),
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl p-6 shadow-sm">
                ...
                <p className="text-gray-600 dark:text-gray-400 dark:text-gray-400">Here's what's happening with your services today.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">My Services</p>
                ...
                >
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Subcategories</p>
            ...
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">All Service Bookings Overview</h3>
                    <button
            ...
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                <div className="flex items-center justify-between mb-6">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-gray-100">All AMC Bookings Overview</h3>
                    <button
            ...
            <div className="bg-white dark:bg-gray-800 dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    >
                        <span className="material-symbols-outlined text-gray-600 dark:text-gray-400 text-[32px]">add_circle</span>
                        <div>
                            <p className="font-semibold text-gray-900 dark:text-gray-100">Add New Service</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Create a service offering</p>
                        </div>
                    </button>
                    <button
                        onClick={() => setActiveSection('services')}
                        className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors text-left"
                    >
                        <span className="material-symbols-outlined text-gray-600 dark:text-gray-400 text-[32px]">inventory_2</span>
                        <div>
                            <p className="font-semibold text-gray-900 dark:text-gray-100">Browse Services</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">Explore all services</p>
                        </div>
                    </button>
                    <button
                        onClick={() => setActiveSection('my-bookings')}
                        className="flex items-center gap-3 p-4 bg-gray-50 dark:bg-gray-900 hover:bg-gray-100 dark:bg-gray-800 rounded-lg transition-colors text-left"
                    >
                        <span className="material-symbols-outlined text-gray-600 dark:text-gray-400 text-[32px]">calendar_month</span>
                        <div>
                            <p className="font-semibold text-gray-900 dark:text-gray-100">My Bookings</p>
                            <p className="text-sm text-gray-600 dark:text-gray-400">View your bookings</p>
                        </div>
                    </button>
                </div>
            </div>
